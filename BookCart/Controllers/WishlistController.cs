...
namespace BookCart.Controllers
{
    ...
    public class WishlistController : Controller
    {
        ...
        public WishlistController(IWishlistService wishlistService, IProductService bookService, IUserService userService)
        {
        ...
        public async Task<List<Product>> Post(int userId, int bookId)
        {
