...
{
    public partial class SravyEcommerceDBContext : DbContext
    {
        public SravyEcommerceDBContext()
        {
        }

        public SravyEcommerceDBContext(DbContextOptions<SravyEcommerceDBContext> options)
            : base(options)
        {
        }
